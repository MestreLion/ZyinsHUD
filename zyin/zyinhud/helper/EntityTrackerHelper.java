...
public class EntityTrackerHelper
{
    ...
    public static int maxOverlayMessagesRendered = 200;	//Renders only the first nearest X entities names
     ...
     * check at the start of RenderAllEntityOverlays().
     * @param entity
    ...
    /**
     * Calculates the on-screen (x,y) positions of entities in the world and renders various overlays on them.
     */
    public static void RenderAllEntityOverlays()
    {
                ...
                && mc.inGameHasFocus)
        {
            ...
            for (Object object : mc.theWorld.loadedEntityList)
            {
                ...
                RenderEntityOverlays(entity, x, y, entityIsBehindUs);
                i++;
            }
        }
    }
